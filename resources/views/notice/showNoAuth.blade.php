...
<head>
    ...
    <title>HR Management Circulars</title>
...
<div class="d-flex align-items-stretch">
    <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
            <section class="py-5">
                @if(session('ApplicantCreateSuccess'))
                    <div class="alert alert-success text-center">
                        {{session('ApplicantCreateSuccess')}}
                    </div>
                ...
                <div class="row">
                    <div class="col mb-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                {{--                                {{dd(\Illuminate\Support\Facades\Auth::guard('applicant')->id())}}--}}
                                    ...
                                    @foreach($notices as $i => $n)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a href="{{route('notice.view.noAuth', ['nid' => $n->id])}}"
                                                       class="btn btn-sm btn-outline-primary">Already Applied</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
