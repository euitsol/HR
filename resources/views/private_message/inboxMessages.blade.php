                            ...
                            <div class="row border-bottom mt-3">
                                <div class="col">
                                    ...
                                    <div style="display:flex">
                                        @isset($item['file']) <span class="mr-2"><i class="fa fa-file"></i></span> @endisset
                                ...
                                <div class="col">
                                    <a href="{{ route('message.inbox.delete', $item['id']) }}" class="btn btn-danger btn-sm float-right" onclick="return confirm('Are you sure?')">
